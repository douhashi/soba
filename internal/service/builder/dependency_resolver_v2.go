...
// DependencyResolverV2 resolves component dependencies with new logging
type DependencyResolverV2 struct {
...
// NewDependencyResolverV2 creates a new dependency resolver with new logging
func NewDependencyResolverV2(cfg *config.Config, workDir string, logFactory *logging.Factory, handler ErrorHandler) *DependencyResolverV2 {
	return &DependencyResolverV2{
		config:       cfg,
		workDir:      workDir,
...
func (r *DependencyResolverV2) ResolveClients(ctx context.Context) (*ResolvedClients, error) {
...
func (r *DependencyResolverV2) ResolveServices(ctx context.Context, clients *ResolvedClients) (*ResolvedServices, error) {
...
func (r *DependencyResolverV2) createWorkspaceManager(clients *ResolvedClients) GitWorkspaceManager {
